...
#pragma warning restore CS8604 // Possible null reference argument.
            ...
            var body = new {
                ...
                htmlContent = $"<!DOCTYPE html><html lang=\"en\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><title>Document</title></head><body><div style=\"width: 100%;\"><main style=\"width: 100%; max-width: 400px; margin: 100px auto;\"><h2 style=\"margin-bottom: 40px;font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; color: #663300;\">Chengement de mot de passe :</h2><span><p style=\"font-size: 15px; ;font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; color: #663300;\">Bonjour</p><h4 style=\";font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; color: #663300;\">{_name}.</h4><p style=\"font-size: 15px; ;font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif; color: #663300;\">Cliquez sur le bouton ci-dessous pour réinitialiser votre mot de passe.</p></span><a href=\"{resetLink}\"><button style=\"background-color: #663300;color: white;padding: 8px 15px;border: none;border-radius: 3px;cursor: pointer;transition: 200ms;outline: none;font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;margin-top: 25px;\">Réinitialiser mon mot de passe</button></a></main></div></body></html>"
            };
